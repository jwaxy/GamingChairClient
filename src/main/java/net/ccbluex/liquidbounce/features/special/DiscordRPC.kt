...
object DiscordRPC {
    ...
    private var website = "jwaxy.is-a.dev/GamingChairClient - "
    ...
    private fun update() {
        ...
        builder.setLargeImage(if (discordRPCModule.animated.get()){"https://i.ibb.co/pRPZf9L/icon.gif"} else {"https://i.ibb.co/JxVwKFZ/icon.png"})
