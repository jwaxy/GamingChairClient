...
public class RenderWings extends ModelBase {
    ...
    public RenderWings() {
        if(WingMode.equals("Dragon")) { this.location = new ResourceLocation("gamingchair/wings/DragonWings.png"); } else if(WingMode.equals("Simple")) { this.location = new ResourceLocation("gamingchair/wings/NeonWings.png"); }
